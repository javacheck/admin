...
import cn.self.mvc.admin.bean.Role;
...
public final class SecurityUtils {
	...
	public static boolean hasPermission( Permission.DefaultPermission defaultPermission) {
	...
	public static boolean isRole(Role.DefaultRole defaultRole) {
		List<Role> list = (List<Role>) WebUtils.getAttributeFromSession(Constants.ROLE_SESSION_KEY);
		for (Role role : list) {
